...
{
public:
	KardelenAPIServer(PtzpDriver *ptzp);
...
protected:
	virtual void setPosi(kaapi::PosInfo *posi);
	virtual void fillCameraStatus(kaapi::CameraStatus *response);
	virtual int64_t getCapabilities();
