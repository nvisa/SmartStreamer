...
void asel_direct_track(unsigned char *buf, int size, int width, int height,int record_case,int debug_case,unsigned char *meta,float pan_tilt_zoom_read[],float trackObj[],int init_direct_track);
