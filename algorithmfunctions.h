...
void asel_via_base(unsigned char *buf, int size, int width, int height,int RGB_case,int record_case,int shadow_case,int ill_norm_case,int debug_case,int stabilization_case,int privacy_case, unsigned char* meta,float pan_tilt_zoom_read[],bool &alarmFlag,int init_viabase,int sensitivity, int classification);
